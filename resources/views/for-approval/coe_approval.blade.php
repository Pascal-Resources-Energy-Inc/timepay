                          ...
                          <tr>
                            ...
                            <td align="center" id="tdActionId{{ $form_approval->id }}" data-id="{{ $form_approval->id }}">
                              ...
                              @elseif($form_approval->status == 'Pending' && $user_role == 'coe_approver')
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-target="#coe-approved-remarks-{{ $form_approval->id }}" data-toggle="modal" title="Approve">
                            ...
                            <td>
                              ...
                              <small>Position: {{$form_approval->user->employee->position ?? 'N/A'}}</small> <br>
                              <small>Location: {{$form_approval->user->employee->location ?? 'N/A'}}</small> <br>
                              <small>Department: {{ $form_approval->user->employee->department ? $form_approval->user->employee->department->name : "N/A"}}</small>
                            </td>
