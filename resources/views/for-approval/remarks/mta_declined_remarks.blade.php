<div class="modal fade" id="mta-declined-remarks-{{$mta->id}}" tabindex="-1" role="dialog" aria-labelledby="declinedMTAremarks" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="declinedMTAremarks">Are you sure you want to Decline this Monetized Transportation Allowance?</h5>
