<div class="modal fade" id="to-declined-remarks-{{$to->id}}" tabindex="-1" role="dialog" aria-labelledby="declinedTOremarks" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="declinedTOremarks">Are you sure you want to Decline this TO?</h5>
