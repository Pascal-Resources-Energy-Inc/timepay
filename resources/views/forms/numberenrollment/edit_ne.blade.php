<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css">
    ...
    <div class="modal fade" id="edit-ne-{{ $ne->id }}" tabindex="-1" aria-labelledby="numberEnrollmentModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="numberenrollmentForm" method="POST" action="{{ route('edit-ne', $ne->id) }}">
                    @csrf
                    <div class="modal-body">
                       <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="comment" name="comment" rows="3" required>{{ $ne->comment }}</textarea>
                            </div>
