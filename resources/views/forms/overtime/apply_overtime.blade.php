        ...
        <div class="modal-body">
          ...
          <div class="row" id="appOT">
            ...
            <div class="col-md-12 mb-3">
              ...
              <textarea class="form-control" id="remarks" name="remarks" rows="5" placeholder="Provide detail description for this transaction." required></textarea>
            </div>
