<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css">
    ...
    <div class="modal fade" id="edit-pd-{{ $pd->id }}" tabindex="-1" aria-labelledby="payrollDisbursementModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('edit-pd', $pd->id) }}" id="payrollDisbursementForm" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="comment" name="comment" rows="3" required>{{ $pd->comment }}</textarea>
                        </div>
